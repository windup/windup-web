...
public class BootstrapWindup
{
    ...
    public static void main(final String[] args) throws InterruptedException, ExecutionException
    {
        ...
        final String logManagerName = getServiceName(BootstrapWindup.class.getClassLoader(), "java.util.logging.LogManager");
        if (logManagerName != null)
        {
            systemProperties.setProperty("java.util.logging.manager", logManagerName);
        }
        BootstrapWindup bootstrap = new BootstrapWindup(bootstrapArgs.toArray(new String[bootstrapArgs.size()]));
        bootstrap.start();
    }
     ...
     */
    private BootstrapWindup(String[] args)
    {
    ...
    {
        String version = BootstrapWindup.class.getPackage().getImplementationVersion();
        if (version != null)
        {
