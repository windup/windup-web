...
class ModelRelation extends ModelMember
{
    ...
    String toTypeScriptProxy()
    {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("    function get").append(StringUtils.capitalize(this.beanPropertyName)).append("(): ").append(this.type.getTypeScriptTypeName())
                    .append(brackets).append(" {\n");
        ...
        sb.append("    function set").append(StringUtils.capitalize(this.beanPropertyName)).append("(item: ")
                    .append(this.type.getTypeScriptTypeName()).append(brackets).append(") {\n");
        sb.append("        return this.set('").append(this.edgeLabel).append("', item);\n");
        sb.append("    }\n\n");
        if (this.isIterable)
        {
            // A method calling a service to add the adjacent items.
            sb.append("    function add").append(StringUtils.capitalize(this.beanPropertyName)).append("(item: ")
                        .append(this.type.getTypeScriptTypeName()).append(") {\n");
            sb.append("        return this.add('").append(this.edgeLabel).append("', item);\n");
            sb.append("    }\n\n");
            // A method calling a service to remove the adjacent items.
            sb.append("    function remove").append(StringUtils.capitalize(this.beanPropertyName)).append("(item: ")
                        .append(this.type.getTypeScriptTypeName()).append(") {\n");
